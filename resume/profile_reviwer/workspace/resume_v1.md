...
*   **Infrastructure & DevOps:** Kubernetes, AWS, Docker
...
*   Architected and scaled a portfolio of distributed Go microservices to handle over 2 million daily requests for the company's core real-time analytics platform.
*   Led a strategic migration from a monolithic RPC framework to an event-driven architecture to address system-wide performance bottlenecks.
*   Reduced p99 latency by 40% across critical services, significantly improving user experience and system reliability.

**Software Engineer** | Startup Inc | San Francisco, CA | 2018 – 2021
*   Designed and built the company's core REST API in Python from the ground up, establishing the foundational backend for all customer-facing products.
*   Owned the end-to-end development lifecycle by creating the company's first CI/CD pipeline, enabling automated testing and deployments.
